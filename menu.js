...
const DISH_DETAILS={
  ...
  'Бун Хайсан':{image:'assets/menu/bun-haisan.webp',badge:'Морепродукты',description:'Рисовая лапша в ароматном бульоне с морепродуктами и свежей зеленью.',ingredients:['Рисовая лапша','Креветки','Морепродукты','Бульон','Свежая зелень','Лайм']},
  'Фо Тайлан':{image:'assets/menu/pho-thailan.webp',badge:'Пряное',description:'Насыщенный суп с рисовой лапшой, мясом, лаймом и пряными азиатскими нотами.',ingredients:['Рисовая лапша','Мясо','Бульон','Лайм','Чили','Свежая зелень']},
  'Фо Га':{image:'assets/menu/pho-ga.webp',badge:'Классика',description:'Лёгкий ароматный суп с курицей, рисовой лапшой и свежей зеленью.',ingredients:['Рисовая лапша','Курица','Куриный бульон','Лук','Свежая зелень','Лайм']},
  'Нем':{badge:'Классика',description:'Хрустящая вьетнамская закуска, которую подают горячей с соусом и свежей зеленью.'},
  'Нем Том':{badge:'Креветки',description:'Вьетнамская закуска с креветками — яркая подача, хрустящая текстура и соус для сопровождения.'},
  'Нем Куон':{badge:'Свежая подача',description:'Лёгкая вьетнамская закуска в рисовой бумаге со свежими ингредиентами и соусом.'},
  'Димсам':{badge:'На пару',description:'Небольшие азиатские закуски с тонким тестом, подаваемые порционно с соусом.'},
